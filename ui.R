...
navbarPage("Graphical Elicitation MCMC",
        ...
        column(4,
      	...
      	column(4,
        	conditionalPanel(
        		...
        		br(),
        		p("Suppose you are presented with a new dataset of 100 observations. 
        		  How many successes would you expect (approximately)?"
        		),
  ...
  tabPanel("About", icon = icon("info-circle"),
    ...
    column(4,
      ...
      h3("The information below will be updated after the completion of the blind
        review process."
      ),
      br(),
      ...
      # copyright statement
      p("Copyright (c) 2021 by Anonymous."),
